...
const HOMEPAGE_IMAGES = {
  ...
  appointment:
    "/assets/img/homepage-images/pexels-polina-tankilevitch-5234582.jpg",
  resourceOne:
...
const HOMEPAGE_FEATURED_SERVICES = MENTAL_HEALTH_SERVICES.slice(0, 3);
...
const CARE_COUNTERS = [
  {
    ...
    detail:
      "Sessions designed to stay simple, private, and easier to access from anywhere.",
    icon: FiShield,
  },
  {
    value: "90",
    ...
    detail:
      "Appointment times shaped around work, home, school, and everyday routines.",
    icon: FiCalendar,
  },
  {
    value: "24",
    ...
    detail:
      "Care pathways built to feel reachable when you need guidance and follow-up most.",
    icon: FiClock,
  },
  {
    value: "1",
    ...
    detail:
      "More people already connected to ongoing online therapy and psychiatry support.",
    icon: FiUsers,
  },
];

function HomepageIconButton({
  className,
  label,
  iconSrc,
  iconClassName,
...
function HomepageServiceCard({ service }) {
  return (
    <div className="service-item3 overflow-hidden white-bg rounded-4 position-relative">
      ...
      <div className="service-content">
        ...
        <span className="d-block black fw-semibold mb-2">
          {service.subtitle}
        </span>
...
function HomeThreePage() {
  return (
    <PageLayout
      ...
      showSharedFooter={false}
    >
      <div>
        {/* Banner Section Start */}
        <section
          className="banner-section3 fix bg-cover"
          style={{ backgroundImage: 'url("/assets/img/banner/bg-color3.jpg")' }}
        >
              ...
              <div className="col-xxl-7 col-xl-7 col-md-11">
                <div className="hero-content-version3">
                  ...
                  <p>
                    ...
                    through therapy, clinical guidance, and personalized
                    treatment plans. MindReach connects you with licensed
                    professionals for secure virtual sessions so you can get
                    support for anxiety, depression, stress, trauma, ADHD, and
                    more.
                  </p>
              ...
              <div className="col-xxl-5 col-xl-5 col-md-7 home-three-hero__media-col">
                <div className="banner-thumb-items home-three-hero__media">
                  ...
                  <div className="thumb-shape-2">
                    <img
                      src="/assets/img/banner/shape3_1.png"
                      alt="shape-img"
                    />
                  </div>
                  <div className="thumb-shape-3">
                    <img
                      src="/assets/img/banner/search-shape.png"
                      alt="shape-img"
                    />
                  </div>
                  <div className="thumb">
          ...
          <div className="container">
            <div className="section-title text-center mb-60">
              ...
              <h2
                ...
                data-wow-delay=".3s"
              >
                Evidence-based virtual care for{" "}
            ...
            <div className="swiper homepage-services__slider d-lg-none">
              <div className="swiper-wrapper">
            ...
            <div className="homepage-services__pagination swiper-dot dot d-lg-none" />
          ...
          <div className="container">
            <div className="care-counter-wrap3 mindreach-care-stats">
              <div className="mindreach-care-stats__grid">
                {CARE_COUNTERS.map(
                  ({ value, suffix, title, detail, icon }, index) => (
                    <article
                      key={title}
                    ...
                    >
                      <span
                        className="mindreach-care-stat__icon"
                        aria-hidden="true"
                      >
                        {createElement(icon)}
                      </span>
                    ...
                    <div className="testimonial-items3">
                      <div className="testimonial-content">
                        ...
                        <p>
                          ...
                          hours, getting support finally feels manageable. It
                          made asking for help much easier than I expected.
                        </p>
                        <div className="star">
                          <i className="fas fa-star" />
                          <i className="fas fa-star" />
          ...
          <div className="container">
            <div className="feature-wrapper3">
              <div className="row g-4 mb-30">
                ...
                >
                  <div className="feature-thumb">
                    <AppImage
                      src={HOMEPAGE_IMAGES.featureThumb}
                      alt="Therapy session"
                      wrapperClassName="app-image--fill"
                    />
                  </div>
                ...
                >
                  <div className="feature-content">
                    ...
                    <p>
                      Book online anytime and meet from anywhere. No long
                      waitlists, just private, secure care when you need it.
                    </p>
                  </div>
                </div>
              </div>
              <div className="row g-4">
                ...
                >
                  <div
                    className="feature-inner-items2 reveal-left bg-cover rounded-4"
                    style={{
                      backgroundImage: `url(${HOMEPAGE_IMAGES.featureBackground})`,
                    }}
                  >
                    <div className="content">
                  ...
                  <div className="feature-inner-items3">
                    ...
                    <ul className="list-area d-flex flex-column pb-xl-3">
                      <li className="d-flex align-items-center gap-lg-2 gap-1 fs-six">
                        <i className="fa-solid fa-angles-right" /> Compassionate
                        Care
                      </li>
                      <li className="d-flex align-items-center gap-lg-2 gap-1 fs-six">
                      ...
                      <li className="d-flex align-items-center gap-lg-2 gap-1 fs-six">
                        <i className="fa-solid fa-angles-right" /> Confidential
                        Sessions
                      </li>
                      <li className="d-flex align-items-center gap-lg-2 gap-1 fs-six">
                        <i className="fa-solid fa-angles-right" /> Care That
                        Fits Life
                      </li>
                    </ul>
                  </div>
                      ...
                      <div className="pricing-items3">
                        ...
                        <ul className="pricing-list d-flex flex-column mb-4 pb-xl-3">
                          <li className="d-flex align-items-center gap-lg-3 gap-1 fs-six">
                            <i className="fa-regular fa-check" /> Secure virtual
                            session (video)
                          </li>
                          <li className="d-flex align-items-center gap-lg-3 gap-1 fs-six">
                            <i className="fa-regular fa-check" /> Therapist
                            matching support
                          </li>
                          <li className="d-flex align-items-center gap-lg-3 gap-1 fs-six">
                            <i className="fa-regular fa-check" /> Flexible
                            scheduling
                          </li>
                          <li className="d-flex align-items-center gap-lg-3 gap-1 fs-six">
              ...
              <div className="row gx-0 gy-5 align-items-end">
                <div className="col-lg-6 order-lg-0 order-1">
                  <div className="appointment-thumb reveal-left">
                    <AppImage
                      src={HOMEPAGE_IMAGES.appointment}
                      alt="img"
                      wrapperClassName="app-image--fill"
