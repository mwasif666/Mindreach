  ...
  return (
    <PageLayout title={PAGE_TITLE} bodyClass={BODY_CLASS}>
      <div>
        ...
        <section className="banner-section white-bg fix">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <div className="hero-content-version1">
                  <span className="cmn-tag p1-bg heading-font mb-xl-1 mb-2">Madical Care</span>
                  ...
                  <div className="d-flex flex-wrap align-items-center gap-xxl-4 gap-xl-3 gap-3">
                    <a href="/doctor-details" className="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold white overflow-hidden blackbg rounded100 wow fadeInRight" data-wow-delay="0.8s">
                      Make Appoinment
          ...
          <div className="banner-adjust-thumb">
            <div className="container">
              <div className="hero-thumbs1 position-relative w-100 wow fadeInUp" data-wow-delay="0.5s">
                <img src="/assets/img/banner/hero1-thumb.jpg" alt="img" className="rounded-4 w-100" />
                {/* Circle */}
                <div className="text-circle-inner d-center p1-bg">
                  <img src="/assets/img/element/circle-copy.png" alt="img" className="copy" />
                  {/* Ele */}
                  <img src="/assets/img/element/circle-element.png" alt="circle" className="text-circle" />
                </div>
                {/* Ele */}
                <img src="/assets/img/element/dots-element.png" alt="img" className="hero-dot-element" />
              </div>
            </div>
            {/* Element */}
            <img src="/assets/img/element/hero-shape-elemenet.png" alt="img" className="hero-shape-element" />
          </div>
          {/* Element */}
          <img src="/assets/img/element/feature-element.png" alt="img" className="hero-element1" />
        </section>
        {/* Adjust Category Start */}
        <section className="adjust-category-section fix space-top space-bottom">
          <div className="container">
            <div className="row g-4">
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="adjust-category-items">
                  <div className="icon"><img src="/assets/img/icon/f-icon6.png" alt="icon" /></div>
                  <h4 className="black fw_600 wow fadeInUp" data-wow-delay="0.4s">Your health our priority wellness
                    Healing with heart</h4>
                  <a href="/doctor-details" className="read-more text-nowrap heading-font d-inline-flex align-items-center pb-1">
                    Read More
                    <svg width={22} height={16} viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M21.2074 9.29688H0.791016V7.54688H21.2074V9.29688Z" fill="#090A0B" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M20.3338 7.54688C16.2184 7.54688 12.8555 11.166 12.8555 15.0252V15.9002H14.6055V15.0252C14.6055 12.0951 17.2218 9.29688 20.3338 9.29688H21.2083V7.54688H20.3338Z" fill="#090A0B" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M20.3338 9.29675C16.2184 9.29675 12.8555 5.67759 12.8555 1.81836V0.943359H14.6055V1.81836C14.6055 4.74854 17.2218 7.54675 20.3338 7.54675H21.2083V9.29675H20.3338Z" fill="#090A0B" />
                    </svg>
                  </a>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="adjust-category-items">
                  <div className="icon"><img src="/assets/img/icon/f-icon4.png" alt="icon" /></div>
                  <h4 className="black fw_600 wow fadeInUp" data-wow-delay="0.6s">A healthy tomorrow starts today
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="adjust-category-items">
                  <div className="icon"><img src="/assets/img/icon/f-icon5.png" alt="icon" /></div>
                  <h4 className="black fw_600 wow fadeInUp" data-wow-delay="0.9s">Your health our priority wellness
                    Healing with heart</h4>
                  <a href="/doctor-details" className="read-more text-nowrap heading-font d-inline-flex align-items-center pb-1">
                    Read More
                    <svg width={22} height={16} viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="about-section fix space-bottom">
          <div className="container">
        ...
        <section className="feature-section fix section-padding">
          <div className="container">
            <div className="featue-wrapper position-relative white-bg">
                ...
                <div className="feature-items">
                  <div className="feature-left d-lg-flex d-grid gap-3 flex-lg-nowrap flex-wrap justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-xxl-4 gap-xl-3 gap-2">
                      ...
                      <h4><a href="/project-details" className="black fw_600">Quality Care <br /> Exceptional
                          Service</a></h4>
                    </div>
                  ...
                  <a href="/project-details" className="common-btn cmn-border text-nowrap d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s">
                    Read More
                ...
                <div className="feature-items">
                  <div className="feature-left d-lg-flex d-grid gap-3 flex-lg-nowrap flex-wrap justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-xxl-4 gap-xl-3 gap-2">
                      ...
                      <h4><a href="/project-details" className="black fw_600">Healing Lives One <br /> Patient
                          at a Time</a></h4>
                    </div>
                    <ul className="feature-list d-flex flex-column gap-1">
                      <li>
                ...
                <div className="feature-items">
                  <div className="feature-left d-lg-flex d-grid gap-3 flex-lg-nowrap flex-wrap justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-xxl-4 gap-xl-3 gap-2">
                      ...
                      <h4><a href="/project-details" className="black fw_600">Caring for You Caring <br /> for
                          Tomorrow</a></h4>
                    </div>
                    <ul className="feature-list d-flex flex-column gap-1">
                      <li>
              ...
              {/* Element*/}
              <a href="/project-details" className="feature-element">
              ...
              <div className="row g-4 justify-content-lg-between">
                ...
                <div className="col-lg-5">
                  <div className="special-tag-inner d-flex flex-column gap-xxl-4 gap-3">
                    <a href="/doctor-details" className="special-tag d-flex align-items-center gap-3 gap-2 rounded-3 heading-font cmn-border">
                      <img src="/assets/img/icon/arrow-right-black.png" alt="icon" />
                    ...
                    <div className="special-behaind text-center">
                      <div className="box position-relative">
                        ...
                        <a href="/doctor-details" className="common-btn arrow-white-adding box-style white-border d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold py-3 white overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s">
                          Read More
                          <img src="/assets/img/icon/arrow-right-white.png" alt="icon" />
                        </a>
                      </div>
        ...
        {/* News Section Start */}
        <section className="news-section body-bg space-bottom fix position-relative">
          <div className="container">
            <div className="section-title-area d-flex flex-lg-nowrap flex-wrap gap-lg-2 gap-2 align-items-end mb-60">
              <div className="section-title">
              ...
              <p className="blog-pra wow fadeInLeft">
              ...
              <div className="row justify-content-center g-4">
                <div className="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                  <div className="news-single-items">
                    <div className="news-image news-image1 reveal-left mb-0">
                      <img src="/assets/img/blog/blogv1-1.jpg" alt="news-img" />
                      <h4 className="news-title white">
                        <a href="/blog-details" className="white fw_700">
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="blog-inner-style1 d-flex flex-column">
                    <div className="news-single-items blog-style1 d-flex flex-sm-nowrap flex-wrap align-items-center justify-content-between gap-md-0 gap-2 wow fadeInUp" data-wow-delay=".3s">
                      <div className="d-flex align-items-center gap-xl-4 gap-2">
                        <a href="/blog-details" className="news-image rounded-4">
                          <img src="/assets/img/blog/blogv1-2.jpg" alt="news-img" className="rounded-4" />
                        </a>
                        <h4>
                          <a href="/blog-details">
                      ...
                      <a href="/blog-details" className="read-more text-nowrap heading-font d-inline-flex align-items-center pb-1">
                        Read More
                        <svg width={22} height={16} viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fillRule="evenodd" clipRule="evenodd" d="M21.2074 9.29688H0.791016V7.54688H21.2074V9.29688Z" fill="#090A0B" />
                          <path fillRule="evenodd" clipRule="evenodd" d="M20.3338 7.54688C16.2184 7.54688 12.8555 11.166 12.8555 15.0252V15.9002H14.6055V15.0252C14.6055 12.0951 17.2218 9.29688 20.3338 9.29688H21.2083V7.54688H20.3338Z" fill="#090A0B" />
                    ...
                    <div className="blog-style1-line" />
                    <div className="news-single-items blog-style1 d-flex flex-sm-nowrap flex-wrap align-items-center justify-content-between gap-md-0 gap-2 wow fadeInUp" data-wow-delay=".5s">
                      <div className="d-flex align-items-center gap-xl-4 gap-2">
                        <a href="/blog-details" className="news-image rounded-4">
                          <img src="/assets/img/blog/blogv1-3.jpg" alt="news-img" className="rounded-4" />
                        </a>
                        <h4>
                          <a href="/blog-details">
                    ...
                    <div className="blog-style1-line" />
                    <div className="news-single-items blog-style1 d-flex flex-sm-nowrap flex-wrap align-items-center justify-content-between gap-md-0 gap-2 wow fadeInUp" data-wow-delay=".7s">
                      <div className="d-flex align-items-center gap-xl-4 gap-2">
                        <a href="/blog-details" className="news-image rounded-4">
                          <img src="/assets/img/blog/blogv1-4.jpg" alt="news-img" className="rounded-4" />
                        </a>
                        <h4>
                          <a href="/blog-details">
