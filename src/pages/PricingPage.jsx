...
const PAGE_TITLE = "Pricing|| Medizen || Medizen React Template"
  ...
  return (
    <PageLayout title={PAGE_TITLE} bodyClass={BODY_CLASS}>
      <div>
        ...
        {/* Faq Section Start */}
        <section className="faq-section space-bottom fix">
          <div className="container">
            <div className="row g-4 justify-content-between align-items-end">
              <div className="col-lg-6">
                <div className="section-title mb-4">
                  <span className="cmn-tag p1-bg heading-font">Pricing</span>
                ...
                <div className="accordion border-0 d-flex flex-column gap-xxl-4 gap-3" id="accordionExample">
                  <div className="accordion-item white-bg">
              ...
              <div className="col-lg-5">
                <div className="counter-wrap ps-xxl-5">
                  ...
                  <div className="counter-items box-style first-box wow fadeIn" data-wow-delay="0.6s">
                    <div className="content">
                      <h2><span className="count">80</span>k+</h2>
                      <p>Client review</p>
                    </div>
                  </div>
                  <div className="counter-items box-style first-box wow fadeIn" data-wow-delay="0.7s">
                    <div className="content">
                      <h2><span className="count">105</span>+</h2>
