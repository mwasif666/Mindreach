...
const PAGE_TITLE = "Blog || Medizen || Medizen React Template"
            ...
            <div className="row g-4">
              <div className="col-lg-8">
                <div className="blog-details-left">
                  <div className="blog-items2 d-grid rounded-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div className="thumb rounded-4 position-relative w-100">
                      <img src="/assets/img/blog/blog-details1.jpg" alt="img" className="rounded-4 w-100" />
                    ...
                    <div className="content">
                      ...
                      <h4 className="mb-4"><a href="/blog-details" className="black">Healing Lives, One Patient at
                  ...
                  <div className="blog-items2 d-grid rounded-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div className="thumb rounded-4 position-relative w-100">
                      <img src="/assets/img/blog/blog-details2.jpg" alt="img" className="rounded-4 w-100" />
                      <div className="d-flex gap-1 align-items-center blog-date">
                        <div className="icon d-center"><i className="fa-solid fa-calendar-days" /></div>
                        <span className="cont">23 Dec 2023</span>
                      </div>
                    ...
                    <div className="content">
                      ...
                      <h4 className="mb-4"><a href="/blog-details" className="black">A healthy tomorrow starts
                  ...
                  <div className="blog-items2 d-grid rounded-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div className="thumb rounded-4 position-relative w-100">
                      <img src="/assets/img/blog/blog-details3.jpg" alt="img" className="rounded-4 w-100" />
                      <div className="d-flex gap-1 align-items-center blog-date">
                        <div className="icon d-center"><i className="fa-solid fa-calendar-days" /></div>
                        <span className="cont">23 Dec 2023</span>
                      </div>
                    ...
                    <div className="content">
                      ...
                      <h4 className="mb-4"><a href="/blog-details" className="black">Your health, our priority
                ...
                <ul className="blog-pagination">
                  ...
                  <li><a href="javascript:void(0)"><i className="fa-solid fa-angles-right" /></a></li>
                </ul>
              </div>
